...
export default {
  data() {
    return {
      // 示例图片数据，应包含图片URL和文本
      images: [
        {url:'../../../static/objective/banana.jpg', text: 'Banana', audio: '../../../static/objectaudio/banana.mp3'},
        {url: '../../../static/objective/orange.jpg', text: 'Orange', audio: '../../../static/objectaudio/orange.mp3' },
        {url: '../../../static/objective/grape.jpg', text: 'Grape', audio: '../../../static/objectaudio/grape.mp3' },
        {url: '../../../static/objective/pear.jpg', text: 'Pear', audio: '../../../static/objectaudio/pear.mp3' },
        {url: '../../../static/objective/tomato.jpg', text: 'Tomato', audio: '../../../static/objectaudio/tomato.mp3' },
              // 添加更多图片
        ],
