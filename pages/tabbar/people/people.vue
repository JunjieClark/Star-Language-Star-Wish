...
export default {
  data() {
    return {
      // 示例图片数据，应包含图片URL和文本
      images: [
      			{url:'../../../static/people/bear.jpg', text: 'Bear', audio: '../../../static/peopleaudio/bear.mp3' },
                {url: '../../../static/people/deer.jpg', text: 'Deer', audio: '../../../static/peopleaudio/deer.mp3' },
                {url: '../../../static/people/dog.jpg', text: 'Dog', audio: '../../../static/peopleaudio/dog.mp3' },
                {url: '../../../static/people/fox.jpg', text: 'Fox', audio: '../../../static/peopleaudio/fox.mp3' },
				{url: '../../../static/people/I.jpg', text: 'I', audio: '../../../static/peopleaudio/I.mp3' },
                                // 添加更多图片
        ],
